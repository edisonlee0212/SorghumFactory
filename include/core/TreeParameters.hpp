...
#pragma region Bud fate
		...
		/**
		 * \brief How much inhibitor will be preserved when being transited to parent internodes. 
		 */
		float m_inhibitorDistanceFactor = 0.8f;
		/**
		 * \brief How much resource will an apical bud receive compare with lateral buds from resource allocation 
		 */
		float m_resourceWeightApical = 1.0f;
		/**
		 * \brief The variance of weight between apical and lateral buds for resource allocation.
		 */
		float m_resourceWeightVariance = 0.0f;
		/**
		 * \brief How much will the resource allocation favor to main child. (Child with higher level)
		 */
...
#pragma region Environmental
		...
		/**
		 * \brief How much will an internode rotate towards/against the light direction.
		 */
		float m_phototropism = 0.0f;
		/**
		 * \brief How much will an internode rotate towards/against the direction of gravity.
		 */
		float m_gravitropism = 0.1f;
		/**
		 * \brief The base probability of an end internode being cut off due to unknown environmental factors.
		 */
		float m_randomCutOff = -0.02f;
		/**
		 * \brief How much the probability of an end internode being cut off due to unknown environmental factors will increase due to internode aging.
		 */
		float m_randomCutOffAgeFactor = 0.002f;
		/**
		 * \brief The maximum probability of an end internode being cut off due to unknown environmental factors will increase due to internode aging.
		 */
		float m_randomCutOffMax = 0.03f;
		/**
		 * \brief The limit of lateral branches being cut off when too close to the root.
		 */
...
#pragma endregion
		...
		/**
		 * \brief The strength of a branch fight against gravity bending with its thickness.
		 */
