...
struct SORGHUM_FACTORY_API SorghumPinnacleGenerator {
...
struct SORGHUM_FACTORY_API SorghumStemGenerator {
...
struct SORGHUM_FACTORY_API SorghumLeafGenerator {
  int m_leafIndex;
...
public:
  ...
  SorghumPinnacleGenerator m_pinnacleDescriptor;
...
#pragma region Base
  SorghumStemGenerator m_stemDescriptor;
  std::vector<SorghumLeafGenerator> m_leafDescriptors;
#pragma endregion
};
} // namespace SorghumFactory