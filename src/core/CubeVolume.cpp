...
bool CubeVolume::InVolume(const GlobalTransform &globalTransform,
  ...
  auto min = glm::vec3((globalTransform.m_value * glm::translate(m_minMaxBound.m_min))[3]);
  auto max = glm::vec3((globalTransform.m_value * glm::translate(m_minMaxBound.m_max))[3]);
